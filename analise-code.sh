...
cd authentication-service && c mvn clean install &&/usr/share/maven/bin/mvn sonar:sonar && cd ..
cd horizo-service && c mvn clean install &&/usr/share/maven/bin/mvn sonar:sonar && cd ..